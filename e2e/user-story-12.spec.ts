...
describe("US-12: Indoor Shortest Travel Plan", () => {
  it("should show the fastest path by taking the stairs on the same floor", async () => {
  ...
  it("should show the fastest path by taking the stairs on two different floors", async () => {
    await element(by.id("searchInput")).tap();
